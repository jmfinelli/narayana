...
public class Listener extends Thread {
    ...
    */
            ...
            try {
                ...
                if (addConnection(conn)) {
                    ...
                    Connection.Callback callback = new Connection.Callback() {
                        private final Socket _conn = conn;
    ...
    private final ServerSocket _listener_socket;
    private final int _listener_port;

    // Flag to indicate when to shutdown the listener thread.
    private boolean _stop_listener = false;

    // Timeout used on for accept.
    private final int _listener_socket_timeout_in_msecs = 1500;

    // The work item to execute.
    private final Service _listener_service;
